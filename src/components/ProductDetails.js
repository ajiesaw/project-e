...
const product = {
  name: 'BFjallraven - Foldsack No. 1 Backpack, Fits 15 Laptops',
  price: '$ 109.95',
  href: '#',
  breadcrumbs: [
    { id: 1, name: "Home", href: '/' },
    { id: 2, name: "Men's Clothing", href: '/' },
  ],
  images: [
    {
  ...
  sizes: [
    { name: '5 L', inStock: false },
    { name: '10 L', inStock: true },
    { name: '15 L', inStock: true },
    { name: '20 L', inStock: true },
    { name: '25 L', inStock: true },
    { name: '30 L', inStock: true },
    { name: '35 L', inStock: true },
    { name: '40 L', inStock: true },
  ],
  description:
